"""Regression checks for the luaconfig casebook."""
...
from casebook.harness import assert_expected, luaconfig_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(luaconfig_summary(), assert_expected())
