...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-luaconfig-detail.ps1

lua tests/test_domain_review.lua

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-luaconfig-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-luaconfig-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-luaconfig-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
